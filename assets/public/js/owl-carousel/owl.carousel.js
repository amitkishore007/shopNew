...
;(function($, window, document, undefined) {
    ...
    /**
     * Checks for touch/mouse drag event type and add run event handle$* @protected
     */
    ...
    /**
     * Checks for touch/mouse drag options and add necessery event handle$* @protected
     */
...
;(function($, window, document, undefined) {
     ...
     * @todo Bad style because looks like a readonly method but changes membe$* @protected
     * @returns {Boolean}
     */
