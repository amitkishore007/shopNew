                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        <!-- BEGIN PAGE HEADER-->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title">Edit <?php echo $vandor->username; ?>'s info 
                                                    ...
                                                    <div class="tab-pane active" id="tab_general">
                                                        <div class="form-body">
                                                           ...
                                                           <!-- <div class="form-group">
                                                                ...
                                                                <div class="col-md-10"> 
                                                                    <input type="password" class="form-control vandor_password"  name="vandor[password]" value='<?php echo $vandor->password; ?>' placeholder="Password"> 
 ...
 --><!-- 
                                                              <div class="form-group">
                                                                ...
                                                                <div class="col-md-10"> 
                                                                    <input type="password" class="form-control vandor_retype"  name="vandor[retype]" value='<?php echo $vandor->password; ?>' placeholder="Retype password"> 
